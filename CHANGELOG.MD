...
### Tillagt
- authentication på post queries

## [1.29.0] - 2026-02-19

### Ändrat
 - Tog bort allt som hade med latexify att göra. Så korkad implementation ngl...

## [1.28.0] - 2026-02-19

### Ändrat
 - Flyttat ApiKeys till att använda `AccessEndDate` och därför ha ett slutdatum

## [1.27.1] - 2026-02-12

### Tillagt
- Fixat ett test genom att ändra förväntad ordning för 1.27.0 ändringen i `access.api.test.ts` i variabeln `expectedIndividualAccessLogs`

## [1.27.0] - 2026-02-05

### Tillagt
- query prismaPostAccessLog och getAllIndividualAccessLogs sorterar efter desc på `timestamp`

## [1.26.0] - 2026-01-26

### Tillagt
- query fler poster på id `post.graphql`

## [1.25.0] - 2025-11-24

### Tillagt
- Årsmöte som mötestyp i prisma schemat och `meeting.graphql`

## [1.24.0] - 2025-11-20

### Tillagt
- killergame_admin för killergame.esek.se
- led_admin för led.esek.se

## [1.23.1] - 2025-11-12

### Ändrat
- getPostsForUser filtrerar numera bort framtida poster från listan av poster användaren har 


## [1.23.0] - 2025-11-03

### Tillagt
- shortDescription på post

## [1.22.1] - 2025-11-03

### Ändrat
- Gör att tester som opererar på samma delar av databasen körs i serie, för att undvika race conditions med misslyckade testfall som följd
- Stäng av SKIP_ACCESS_CHECKS i .env.example så att tester som kräver detta inte failar

## [1.22.0] - 2025-11-03

### Tillagt
- accounting_admin för kvitto.esek.se

## [1.21.0] - 2025-10-27

### Tillagt
- Ge namn till val (PrismaElections)

## [1.20.0] - 2025-10-21

### Tillagt
- Lagt till slutdatum for Dörr och Feature åtgång

### Ändrat
- setIndividualAccess och setPostAccess tar nu AccessEndDateInput istället för AccessInput


## [1.19.1] - 2025-10-16

### Ändrat
- bal_admin, expo_admin, salmonella_admin tillagt för roller på admin.esek.se 

## [1.19.0] - 2025-09-23

### Ändrat
- Tillåter att flera val samtidigt är aktiva
- GraphQL query openElection returnerar nu en lista av öppna val istället för endast ett. `Election! -> [Election!]!`
- GraphQL query closeElection kräver ID:t av valet som ska stängas. `closeElection -> closeElection(electionId: Int!)`
